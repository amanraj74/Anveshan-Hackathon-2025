...
class ChurnPredictor:
    ...
    def preprocess_data(self, df, is_training=True):
        ...
        df[numeric_cols] = df[numeric_cols].fillna(df[numeric_cols].mean() if is_training else 0)
        
        # Encode categorical variables (except churn if present)
    ...
    def train(self, X, y):
        ...
        self.feature_names = X_processed.columns  # Set after preprocessing
